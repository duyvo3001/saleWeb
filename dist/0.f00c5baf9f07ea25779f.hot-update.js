...
let UserController = class UserController {
    ...
    updateUser(params, userDto) {
        try {
            console.info(params);
            return new globalClass_1.ResponseData(this.usersevervice.updateUser(params.id, userDto), globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_f = typeof User_dto_1.UserDto !== "undefined" && User_dto_1.UserDto) === "function" ? _f : Object]),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2bbb6479af07cc017a5f")
/******/ })();
/******/ 
/******/ }
;