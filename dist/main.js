...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [app_controller_1.AppController, app_controller_1.AppController],
...
let UserController = class UserController {
    ...
    updateUser() {
        try {
            return new globalClass_1.ResponseData(this.usersevervice.updateUser(), globalEnum_1.HttpStatus.SUCCESS, globalEnum_1.HttpMessage.SUCCESS);
        }
        catch (error) {
            return new globalClass_1.ResponseData(null, globalEnum_1.HttpStatus.ERROR, globalEnum_1.HttpMessage.ERROR);
        }
